    ...
    <div className="bg-[#F8F8F8] min-h-screen pb-24 max-w-md mx-auto" style={{ animation: 'fadeIn 0.15s ease-out' }}>
      ...
      <div className="bg-white rounded-2xl p-4 mx-4 mt-3 border border-[#F0F0F0]">
        ...
        <div className="mt-3 bg-[#F8F8F8] rounded-xl p-3">
          <p className="text-xs text-[#737373] mb-1.5">Need help or want to change your password?</p>
          <div className="flex gap-2">
            <a
              href="https://wa.me/917012783442"
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-[#25D366] text-white rounded-lg px-3 py-2 text-xs font-medium flex items-center justify-center gap-1.5"
            >
            ...
            <a
              href="/contact"
              className="flex-1 border border-[#E5E5E5] rounded-lg px-3 py-2 text-xs font-medium text-[#0A0A0A] text-center"
            >
              Contact Support
            </a>
          </div>
