...
function SectionLabel({ children }) {
  return (
    <div className="col-span-2 border-b border-[#e2e2e2] pb-2 mb-2">
  ...
  return (
    <div className="px-4 py-8 md:px-8 lg:px-16 lg:py-12">
      ...
      <header className="mb-8 lg:mb-12">
        <h2 className="font-serif text-2xl sm:text-[48px] sm:leading-[56px] font-normal text-black mb-2">
          Contact Details
        </h2>
        <p className="text-sm sm:text-base text-[#4c4546] max-w-xl">
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 lg:gap-y-8">
          ...
          <div className="col-span-1 md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 col-span-1 md:col-span-2">
            <input
              type="text"
              value={form.city || ''}
          ...
          {/* State & Country */}
          <div>
            <label className="block text-[12px] uppercase tracking-[0.1em] text-[#4c4546] font-semibold border-b border-[#e2e2e2] pb-2 mb-4">State</label>
            <input
              type="text"
              value={form.state || ''}
          ...
          <div>
            <label className="block text-[12px] uppercase tracking-[0.1em] text-[#4c4546] font-semibold border-b border-[#e2e2e2] pb-2 mb-4">Country</label>
            <input
              type="text"
              value={form.country || ''}
          ...
          {/* Phone */}
          <div>
            <label className="block text-[12px] uppercase tracking-[0.1em] text-[#4c4546] font-semibold border-b border-[#e2e2e2] pb-2 mb-4">Phone</label>
            <input
              type="tel"
              value={form.phone || ''}
          ...
          {/* WhatsApp override */}
          <div>
            <label className="block text-[12px] uppercase tracking-[0.1em] text-[#4c4546] font-semibold border-b border-[#e2e2e2] pb-2 mb-4">WhatsApp Business</label>
            <input
              type="tel"
          ...
          <div className="col-span-1 md:col-span-2">
            <label className="block text-[12px] uppercase tracking-[0.1em] text-[#4c4546] font-semibold border-b border-[#e2e2e2] pb-2 mb-4">Inquiry Email</label>
            <input
              type="email"
              value={form.email || ''}
          ...
          <div className="col-span-1 md:col-span-2 pt-4">
            <label className="block text-[12px] uppercase tracking-[0.1em] text-[#4c4546] font-semibold border-b border-[#e2e2e2] pb-2 mb-5">Business Hours</label>
            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-2 sm:gap-3">
              {DAYS.map((day, i) => (
                <div key={day} className="flex flex-col items-center border border-[#e2e2e2] hover:border-black transition-colors p-2.5 sm:p-3">
                  <span className="text-[10px] uppercase tracking-[0.12em] font-semibold text-[#4c4546] mb-1.5 sm:mb-2">
                    {DAY_LABELS[i]}
                  </span>
                  <input
                    type="text"
                    ...
                    placeholder="Closed"
                    className="w-full text-center text-[11px] bg-transparent border-none focus:outline-none focus:ring-0 text-[#1a1c1c] placeholder:text-[#cfc4c5]"
                  />
                </div>
              ))}
            </div>
          ...
          <div className="col-span-1 md:col-span-2 pt-4">
            ...
            <input
              ...
              className={`${inputCls} border-[#cfc4c5]`}
            />
            <p className="text-[11px] text-[#7e7576] mt-1 font-sans">
          ...
          {/* Social Links */}
          <div className="col-span-1 md:col-span-2 pt-4">
            <label className="block text-[12px] uppercase tracking-[0.1em] text-[#4c4546] font-semibold border-b border-[#e2e2e2] pb-2 mb-5">
              Social Links
            </label>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div>
                <div className="flex items-center gap-2 border-b border-[#cfc4c5] pb-2 mb-3">
          ...
          {/* Footer actions */}
          <div className="col-span-1 md:col-span-2 pt-6 sm:pt-8 flex flex-col-reverse sm:flex-row sm:justify-end items-stretch sm:items-center gap-4 sm:gap-6 border-t border-[#e2e2e2] mt-4">
            <button
              type="button"
